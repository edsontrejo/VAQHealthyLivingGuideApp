...
public class ConfigurationManager
{
    ...
    */
     ...
     * The configuration manager is loaded in two parts,
    ...
    */
    ...
    public void reload() throws Exception
    {
        ...
        try {
            ...
            System.out.println("[CRITICAL] FAILED TO LOAD CONFIG.INI FILE!");
        } finally {
            if (input != null) {
                try {
                    input.close();
    ...
    public boolean getBoolean(String key, boolean defaultValue)
    {
        ...
        {
            System.out.println("Failed to parse key " + key + " with value " + getValue(key) + " to type boolean.");
        }
        return defaultValue;
    }
    ...
    public int getInt(String key, Integer defaultValue)
    {
        ...
        {
            System.out.println("Failed to parse key " + key + " with value " + getValue(key) + " to type integer.");
        }
        return defaultValue;
    }
    ...
    public double getDouble(String key, Double defaultValue)
    {
        ...
        {
            System.out.println("Failed to parse key " + key + " with value " + getValue(key) + " to type double.");
        }
